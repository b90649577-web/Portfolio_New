...
const MetaTags: React.FC<MetaTagsProps> = ({
  ...
  keywords = "Brajesh Kumar, AI Engineer, Full Stack Developer, UI/UX Designer, React Developer, Python Developer, Machine Learning Engineer, Freelance Developer India, Web Developer Portfolio, AI Projects, Open Source Contributor",
