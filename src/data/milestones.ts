...
export const milestones: Milestone[] = [
  ...
  // MARCH 2025
  {
    ...
    description: 'Showcased project and networked with founders at BECon & Startup Expo, IIT Delhi.',
    type: 'event',
    icon: '🏢',
  ...
  },
  {
    ...
    description: 'Built a command-line interface tool to launch and manage project efficiently.',
    type: 'project',
    icon: '⌨️',
  ...
  },
  {
    ...
    description: 'Achieved a milestone of publicly sharing over 100 project with the community.',
    type: 'achievement',
    icon: '📢',
  ...
  },
  {
    ...
    description: 'Developed and released an interactive timeline page to showcase milestones and project.',
    type: 'project',
    icon: '⏳',
  ...
  },
  {
    ...
    description: 'Reusable login/auth UI kit for web project.',
    type: 'project',
    icon: '🔑',
    tags: ['Auth', 'UI Kit'],
    category: 'intermediate'
...
export const resources: Resource[] = [
  ...
  },
  {
    ...
    description: 'Latest professional resume showcasing skills, experience, project, and achievements.',
    type: 'document',
    year: '2025',
    icon: '📄',
  ...
  },
  {
    ...
    description: 'Comprehensive portfolio website showcasing project, skills, experience, and professional journey.',
    type: 'portfolio',
    year: '2025',
    icon: '🌐',
...
export const projectResources: ProjectResource[] = [
  ...
  },
  {
    ...
    title: 'CLI Project Launcher',
    description: 'Command-line interface tool to launch and manage project efficiently.',
    category: 'intermediate',
  ...
  },
  {
    ...
    title: 'Login/Auth UI Kit',
    description: 'Reusable login/auth UI kit for web project with modern design.',
    category: 'intermediate',
